...
- `amount` - Amount of ANUM in base units
...
- *available* - balance contains ANUM ready to be spent, comprised of UTXO records with block maturity blue score over 100.
