...
import {Wallet as WalletImpl, initAnumaFramework} from '@anuma-network/wallet';
import {TxSend, TxInfo} from '@anuma-network/wallet/types/custom-types';
...
export class WorkerCore extends EventEmitter{
	...
	async init(){
		...
		super.init();
		workerLog.debug("before initAnumaFramework")
		await initAnumaFramework();
		workerLog.debug("after initAnumaFramework")
